...
if (UserAdmin($RinteraUser) == TRUE) {
    ...
    while ($f = $r->fetch_array()) {
        ...
        if ($f['ConType'] == 0) {
            $btnText = '<table width=100% border=0><tr><td width=20px align=left><img  title="Base de Datos MYSQL | Rintera" src="iconos/dbr.png" style="width:20px"></td><td
            id ="Tit_' . $f['IdCon'] . '"
            >[' . $f['IdCon'] . '] ' . $f['ConName'] . '</td></tr></table>';
        }

        if ($f['ConType'] == 1) {
            $btnText = '<table width=100% border=0><tr><td width=20px align=left><img title="Base de Datos MYSQL" src="iconos/db.png" style="width:20px"></td><td
            id ="Tit_' . $f['IdCon'] . '"
            >[' . $f['IdCon'] . '] ' . $f['ConName'] . '</td></tr></table>';
        }

        if ($f['ConType'] == 2) {
            $btnText = '<table width=100% border=0><tr><td width=20px align=left><img title="WebService" src="iconos/ws.png" style="width:20px"></td><td
            id ="Tit_' . $f['IdCon'] . '"
            >[' . $f['IdCon'] . '] ' . $f['ConName'] . '</td></tr></table>';
        }
        ...
        if ($f['ConType'] == 3) {
            $btnText = '<table width=100% border=0><tr><td width=20px align=left><img title="WebService: Rintera SQLSERVER-toJSON ASP" src="iconos/wsms.png" style="width:20px"></td><td
            id ="Tit_' . $f['IdCon'] . '"
            >[' . $f['IdCon'] . '] ' . $f['ConName'] . '</td></tr></table>';
        }
        ...
        $ContenidoDelCard =  $ContenidoDelCard . '
            ...
            <td align=right>
                    <button type="button" class="btn btn-success"  onclick="Active(' . $f['IdCon'] . ');" >
                        <img src="iconos/ok2.png" style="width:22px;">
                    </button>
            </td></tr></table>
