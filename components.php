...
function GraficaDona($Labels, $Datas, $Titulo){
    ...
    echo '<div style="width:92%; text-align:right;"><a href="#'.$IdDiv.'_modal" rel=MyModal:open><img src="iconos/max.png" style="" class="btnMaximizar"></a></div>
...
function GraficaProyeccion($Labels, $Datas, $Titulo,$Fill){
    ...
    echo '<div style="width:92%; text-align:right;">
            <a href="#'.$IdDiv.'_modal" rel=MyModal:open><img src="iconos/max.png" style="" class="btnMaximizar"></a>
        </div>
    <canvas id="'.$IdDiv.'" width="100%" height="100%"></canvas>';
