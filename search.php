...
if (MiToken_valida($ElToken, $IdUser, "Search")==TRUE){//Valido
    ...
    while($f = $r -> fetch_array()) {   
        ...
        switch ($f['out_type']) {
            case 0: //Pantalla
                if ($f['var1']=='1' || $f['var2']=='1' || $f['var3']=='1'){
                    ...
                    echo "<img class='icono32' 
                            src='iconos/html.png' title='IdReporte=".$f['id_rep']." | "." | Orientacion: ".$f['orientacion']." | Formato: HTML Interactivo. 
                            Este reporte requiere alimentarse con datos proporcionados por el usuario'>";
                } else {//interactivo
                    echo "<img class='icono32' src='iconos/html0.png'
            ...
            case 1: //Pantalla
                if ($f['var1']=='1' || $f['var2']=='1' || $f['var3']=='1'){
                    //PDF Interactivo
                    echo "<img class='icono32' 
                            src='iconos/datatable.png' title='IdReporte=".$f['id_rep']." | "." | Orientacion: ".$f['orientacion']." | Formato: DataTable Interactivo. 
                            Este reporte requiere alimentarse con datos proporcionados por el usuario'>";
                } else {//interactivo
                    echo "<img class='icono32' src='iconos/datatable0.png'
            ...
            case 2: // PDF
                if ($f['var1']=='1' || $f['var2']=='1' || $f['var3']=='1'){
                    //PDF Interactivo
                    echo "<img class='icono32' 
                            src='iconos/pdf2.png' title='IdReporte=".$f['id_rep']." | "." | Orientacion: ".$f['orientacion']." | Formato: PDF Interactivo. 
                            Este reporte requiere alimentarse con datos proporcionados por el usuario'>";
                } else {//interactivo
                    echo "<img class='icono32' src='iconos/pdf.png'
            ...
            case 3:
                if ($f['var1']=='1' || $f['var2']=='1' || $f['var3']=='1'){
                    //PDF Interactivo
                    echo "<img class='icono32' 
                            src='iconos/excel2.png' title='IdReporte=".$f['id_rep']." | "." | Orientacion: ".$f['orientacion']." | Formato: Excel Interactivo. 
                            Este reporte requiere alimentarse con datos proporcionados por el usuario'>";
                } else {//interactivo
                    echo "<img class='icono32' src='iconos/excel.png'
            ...
            case 4:
                if ($f['var1']=='1' || $f['var2']=='1' || $f['var3']=='1'){
                    //PDF Interactivo
                    echo "<img class='icono32' 
                            src='iconos/word2.png' title='IdReporte=".$f['id_rep']." | "." | Orientacion: ".$f['orientacion']." | Formato: Word Interactivo. 
                            Este reporte requiere alimentarse con datos proporcionados por el usuario'>";
                } else {//interactivo
                    echo "<img class='icono32' src='iconos/word.png'
        ...
        if (UserAdmin($IdUser)==TRUE){
            echo "<a href='edit.php?id=".$f['id_rep']."' title='Haga clic aquí para editar el Reporte'><img src='iconos/mas.png'
            class='iconoMore'
            ></a>";
        }
        ...
        if (PermisoReporte_Ver($IdUser,$f['id_rep'])==TRUE){
            ...
            // echo "<a target=_blank href='solicita/?id=".$f['id_rep']."' title='Haga clic aqui para imprimir el formato de solicitud'><img src='iconos/candado.png' style='width:15px;cursor:pointer;'
